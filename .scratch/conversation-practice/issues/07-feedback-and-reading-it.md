...
- [x] Feedback is generated by a separate call from the Assessment, receiving the Assessment
      and the Transcript and nothing else — in particular not the Persona's private profile.
- [x] The Feedback call is instructed not to re-judge; the verdicts it receives are fixed.
- [x] Assessment demonstrably runs before Feedback.
- [x] The Feedback is prose addressed to the Trainee, referring to specific moments in their
      Attempt.
- [x] The persisted Attempt holds the Transcript, the Assessment, and the Feedback.
- [x] The Trainee reads the Feedback once judging completes, without reloading or navigating
      anywhere manually.
